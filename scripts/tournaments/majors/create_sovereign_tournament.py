#!/usr/bin/env python3
"""
Create and store The Sovereign Tournament major
"""
...
def get_available_courses_for_season(season_number):
    ...
    print(f"DEBUG: COURSES_DB_PATH = {os.path.abspath(courses_db_path)}")
    print(f"DEBUG: TOURNAMENTS_DB_PATH = {os.path.abspath(tournaments_db_path)}")
...
def create_sovereign_tournament(course_id: int, start_date: str, season_number: int, week_number: int):
    """Create The Sovereign Tournament major"""
    
    print(f"🎯 Creating The Sovereign Tournament")
    print("=" * 50)
    
    try:
        # Generate random field size (multiple of 3 between 90 and 114)
        field_size = random.choice([x for x in range(90, 115, 3)])
        ...
        overrides = {
            ...
            'cut_line': {
                'type': 'position',
                'value': 53,
                'description': 'Top 53 and ties advance to weekend'
            },
        ...
        print(f"\n✅ The Sovereign Tournament created successfully!")
        ...
        print(f"❌ Error creating The Sovereign Tournament: {e}")
        return None

def main():
    """Main function to create The Sovereign Tournament"""
    
    print("🏆 The Sovereign Tournament Creator")
    print("=" * 40)
    ...
    print(f"\n📝 Creating The Sovereign Tournament with parameters:")
    print(f"   Name: The Sovereign Tournament")
    # Extract country from location for international courses
    if location and ',' in location:
    ...
    # Create the major
    tournament_id = create_sovereign_tournament(
        course_id=course_id,
        start_date=start_date,
        season_number=season_number,
        week_number=week_number
    ...
    if tournament_id:
        ...
        print(f"\n❌ Failed to create The Sovereign Tournament")
